    ...
    switch (level) {
      ...
      case 2:
        return {
          ...
          story:
            "There's an adorable Brussels Griffon at the pet rescue that needs a home, but the adoption costs and care expenses total $10,000. This sophisticated little dog deserves the best, and you're determined to provide it.\n\nYou've learned the basics of candy trading, but now you need to step up your game. The Brussels Griffon has been waiting for months, and you can't bear the thought of someone else adopting your future best friend.",
      ...
      case 4:
        return {
          ...
          story:
            "At the premium pet boutique, you've met Byul - an elegant, rare breed that costs $20,000. This isn't just about wanting a pet anymore; Byul chose you, following you around the store and refusing to leave your side.\n\nThe store owner says Byul has never acted this way with anyone before. This is destiny, but destiny is expensive. You'll need to master every aspect of the school's candy market to afford your soulmate.",
      ...
      case 7:
        return {
          ...
          story:
            "An exquisite Afghan Hound from a championship bloodline needs a new home after its elderly owner passed away. The adoption fee and specialized care requirements total $35,000, but this graceful creature has captured your heart completely.\n\nThis isn't just about having a pet - it's about preserving a legacy. The Afghan Hound represents everything you've worked toward: elegance, persistence, and the rewards of never giving up on your dreams.",
      ...
      default:
        return {
          title: "A Pet's Love",
          story:
            'Every great candy trader starts with a dream - and your dream is to give a loving home to a pet who needs you as much as you need them.',
          dogImage: require('../../assets/images/doggs/pug.png'),
        };
    }
  };
