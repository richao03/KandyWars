...
export const ScoreboardModal: React.FC<ScoreboardModalProps> = React.memo(({
  ...
  const [activeTab, setActiveTab] = useState<'money' | 'jokers' | 'minigames' | 'periods' | 'privacy'>('money');
  const [tempPlayerName, setTempPlayerName] = useState(playerName);
  
  // Analytics state
  const [topJokersFromMinigames, setTopJokersFromMinigames] = useState<Array<{jokerName: string, count: number, jokerId: number}>>([]);
      ...
      <View style={styles.leaderboardSection}>
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtext}>Be the first to join the leaderboard!</Text>
          </View>
        ) : (
            ...
            <View key={entry.id || index} style={styles.scoreEntry}>
              ...
              <View style={styles.playerInfo}>
                ...
                <View style={styles.gameDetails}>
                  ...
                  >
                    <Text style={styles.difficultyText}>{entry.difficulty}</Text>
                  </View>
              ...
              <View style={styles.scoreContainer}>
                <Text style={styles.finalBalance}>{formatBalance(entry.finalBalance)}</Text>
  ...
  const renderJokersLeaderboard = () => (
    <ScrollView style={styles.tabContent}>
      <View style={styles.leaderboardSection}>
        <Text style={styles.sectionTitle}>🃏 Most Obtained Jokers from Minigames</Text>
        <Text style={styles.sectionSubtitle}>Shows which jokers are won most often from minigames (no player info)</Text>
        ...
        {analyticsLoading ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtext}>Play some minigames to earn jokers and see statistics!</Text>
          </View>
        ) : (
  ...
  const renderMinigamesLeaderboard = () => (
    <ScrollView style={styles.tabContent}>
      <View style={styles.leaderboardSection}>
        ...
        <Text style={styles.sectionSubtitle}>Shows which minigames are played most often (no player info)</Text>
        
        {analyticsLoading ? (
          <View style={styles.loadingContainer}>
            <ActivityIndicator size="large" color="#3b82f6" />
            <Text style={styles.loadingText}>Loading minigame analytics...</Text>
          </View>
        ) : topMinigames.length === 0 ? (
          <View style={styles.emptyState}>
            <Text style={styles.emptyText}>No minigame data yet.</Text>
            <Text style={styles.emptySubtext}>Play some minigames to see statistics!</Text>
          </View>
        ) : (
      ...
      <View style={styles.leaderboardSection}>
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtext}>Play some games to see period statistics!</Text>
          </View>
        ) : (
          topScores
            .sort((a, b) => (b.totalPeriodsPlayed || 0) - (a.totalPeriodsPlayed || 0))
            .map((entry, index) => (
              <View key={entry.id || index} style={styles.scoreEntry}>
                <View style={styles.rankContainer}>
                  <Text style={styles.rankNumber}>{getRankDisplay(index)}</Text>
                ...
                <View style={styles.scoreContainer}>
                  <Text style={styles.finalBalance}>{entry.totalPeriodsPlayed || 0}</Text>
      ...
      <View style={styles.privacyOptions}>
        <View style={styles.privacyItem}>
          ...
          <Switch
            ...
            onValueChange={(value) => updatePrivacySettings({ shareScore: value })}
          />
        </View>
        ...
        <View style={styles.privacyItem}>
          ...
          <Switch
            ...
            onValueChange={(value) => updatePrivacySettings({ sharePlayerName: value })}
          />
        </View>
        ...
        <View style={styles.privacyItem}>
          ...
          <Switch
            ...
            onValueChange={(value) => updatePrivacySettings({ shareStrategies: value })}
          />
        </View>
        ...
        <View style={styles.privacyItem}>
          ...
          <Switch
            ...
            onValueChange={(value) => updatePrivacySettings({ allowAnalytics: value })}
          />
        </View>
      </View>
    </ScrollView>
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.tabBar}>
          ...
          >
            <Text style={[styles.tabText, activeTab === 'jokers' && styles.activeTabText]}>
              🃏 Jokers
            </Text>
          </TouchableOpacity>
          
          <TouchableOpacity
            style={[styles.tab, activeTab === 'minigames' && styles.activeTab]}
            onPress={() => setActiveTab('minigames')}
          >
            <Text style={[styles.tabText, activeTab === 'minigames' && styles.activeTabText]}>
              🎮 Games
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text style={[styles.tabText, activeTab === 'periods' && styles.activeTabText]}>
              📚 Periods
            </Text>
          </TouchableOpacity>
