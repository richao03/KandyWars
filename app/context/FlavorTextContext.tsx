...
const flavorLibrary: Record<FlavorEvent, string[]> = {
  ...
  PIGGY_BANK: [
    'Your piggy bank has seen better days, but so has your wallet.',
    'The ceramic pig sits heavy with the weight of your candy empire.',
    'Every coin that drops echoes with the sound of sweet success.',
    'This little pig went to market... and made bank.',
    "Your mom thinks it's cute how seriously you take saving money.",
    "The pig's painted smile knows all your financial secrets.",
    'Sometimes you shake it just to hear the music of money.',
    'This pink guardian has kept your candy profits safe for months.',
    'Every deposit feels like feeding a very expensive pet.',
    "The crack on its side reminds you that even banks aren't forever.",
    'Your piggy bank: the real MVP of your candy operation.',
    "One coin at a time, you're building something bigger.",
    "The pig doesn't judge your spending habits... yet.",
    'This ceramic companion has witnessed every business decision.',
    'Your piggy bank rattles with the rhythm of entrepreneurship.',
    'Some kids have imaginary friends. You have a profitable pig.',
    'The weight of success literally sits on your dresser.',
    'Every withdrawal feels like borrowing from your future self.',
    'Your piggy bank: where candy dreams become cold hard cash.',
    "The pig's eyes seem to follow your money everywhere.",
    "This isn't just saving—it's strategic resource management.",
    "Your mom bought this pig. Now it's your business partner.",
    'The slot on top has seen more action than a Vegas casino.',
    'Sometimes you wonder if the pig gets a cut of the profits.',
    'Every coin drop is a small victory in your candy war.',
  ],
  DEFAULT: [
